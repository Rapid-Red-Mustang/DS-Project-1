...
library(dplyr)
ipums = select(ipums, c(2:5,8,9:10))
...
print("Number of employed people in training set = ", str(nrow(train %>% filter(EMPSTAT==1))))
print("Number of unemployed people in training set = ", str(nrow(train %>% filter(EMPSTAT==0))))

print("Number of employed people in testing set = ", str(nrow(test %>% filter(EMPSTAT==1))))
print("Number of unemployed people in testing set = ", str(nrow(test %>% filter(EMPSTAT==0))))
```
