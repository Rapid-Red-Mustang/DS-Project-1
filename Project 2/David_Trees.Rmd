...
Decision Trees are a type of supervised machine learning algo that work to form categorical data. In many ways, they do exactly what they sound like: allow the reader to decide on the probability of certain outcomes based on concurrent and past criteria.
