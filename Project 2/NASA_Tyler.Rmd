...
loadPkg("leaps")
reg.leaps <- regsubsets(hazardous~relative_velocity + absolute_magnitude + miss_distance, data = newdata_glm, nbest = 1, method = "exhaustive")
...
glm.nasa <- glm(formula = hazardous ~ miss_distance + absolute_magnitude + relative_velocity, data = newdata_glm, family = binomial)
summary(glm.nasa)
